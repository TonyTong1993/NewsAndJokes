...
@implementation YHPhotoBrowserPhoto
- (void)setPhotoObj:(id)photoObj{
    _photoObj = photoObj;
    
    if ([photoObj isKindOfClass:[YHPhotoAssets class]]) {
        YHPhotoAssets *asset = (YHPhotoAssets *)photoObj;
        self.asset = asset;
...
+ (instancetype)photoAnyImageObjWith:(id)imageObj{
    YHPhotoBrowserPhoto *photo = [[self alloc] init];
