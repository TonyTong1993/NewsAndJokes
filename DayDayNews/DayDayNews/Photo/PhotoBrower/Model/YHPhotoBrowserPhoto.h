...
@protocol YHPhotoPickerBrowserPhoto <NSObject>
@end
@interface YHPhotoBrowserPhoto : NSObject<YHPhotoPickerBrowserPhoto>
 ...
 *  保存相册模型
 */
@property (nonatomic, strong) YHPhotoAssets *asset;
/**
 *  URL地址
 */
