...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDBackgroundColor = [UIColor colorWithRed:0.663 green:0.939 blue:1.000 alpha:1.000];
        ...
        SVProgressHUDDefaultMaskType = SVProgressHUDMaskTypeClear;//SVProgressHUDMaskTypeNone;
    }
